...
char const *disp_char(int i)
{
    ...
    case 0:
        return " ";
    case 1:
        return "\xe2\x96\x80"; // 2580 - top
    case 2:
        return "\xe2\x96\x84"; // 2584 - down
    case 3:
        return "\xe2\x96\x88"; // 2588 - both

    case 4:
        return "\xe2\x95\x90"; // 2550 - ==
    case 5:
        return "\xe2\x95\x92"; // 2552 - ,=
    case 6:
        return "\xe2\x95\x95"; // 2555 - =,
    case 7:
        return "\xe2\x95\x98"; // 2558 - '=
    case 8:
        return "\xe2\x95\x9b"; // 255b - ='
    case 9:
        return "\xe2\x94\x82"; // 2502 - |

    case 11:
        return "\xe2\x96\xbc"; // 25bc - triangle down
    case 12:
        return "\xe2\x96\xb2"; // 25b2 - triangle up
    default:
        break;
    }
    return " ";
